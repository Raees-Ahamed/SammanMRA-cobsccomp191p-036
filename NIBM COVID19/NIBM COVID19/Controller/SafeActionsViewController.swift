...
class SafeActionsViewController:UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que2 = safeAction(imgName: "no-group", headerText: "Avoid crowd", description: "Please avoid visiting crowded places. Crowded places are the number one Covid 19 hotspots")
        ...
        let que4 = safeAction(imgName: "liquid-soap", headerText: "Use hand sanitizer", description: "Sanitize your hand frequently will kill all the germs in your hands")
